                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ml-6">
                        <x-dropdown align="right" width="48">
                            ...
                            <x-slot name="content">
                                <x-dropdown-link :href="route('province.index')">
                                    {{ __('Province') }}
                                </x-dropdown-link>

                                <x-dropdown-link :href="route('regency.index')">
                                    {{ __('Regency') }}
                                </x-dropdown-link>

                                <x-dropdown-link :href="route('district.index')">
                                    {{ __('District') }}
                                </x-dropdown-link>

                                <x-dropdown-link :href="route('village.index')">
                                    {{ __('Village') }}
                                </x-dropdown-link>
                            </x-slot>
                        </x-dropdown>
                    ...
                    <x-nav-link :href="route('destination.index')" :active="request()->routeIs('destination.*')">
                        {{ __('Destination') }}
                    </x-nav-link>
